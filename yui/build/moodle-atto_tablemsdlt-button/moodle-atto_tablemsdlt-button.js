...
/**
 * @module moodle-atto_tablemsdlt-button
 */

/**
 * Atto text editor table plugin.
 *
 * @namespace M.atto_tablemsdlt
 * @class Button
 * @extends M.editor_atto.EditorPlugin
 */

var COMPONENT = 'atto_tablemsdlt',
    DEFAULT = {
        BORDERSTYLE: 'none',
        BORDERWIDTH: '1'
    },
    ...
    TEMPLATE = '' +
        '<form class="{{CSS.FORM}}">' +
            '<label for="{{elementid}}_atto_tablemsdlt_caption">{{get_string "caption" component}}</label>' +
            '<input class="{{CSS.CAPTION}} fullwidth" id="{{elementid}}_atto_tablemsdlt_caption" required />' +
            '<br/>' +
            '<br/>' +
            '<label for="{{elementid}}_atto_tablemsdlt_captionposition" class="sameline">' +
            '{{get_string "captionposition" component}}</label>' +
            '<select class="{{CSS.CAPTIONPOSITION}}" id="{{elementid}}_atto_tablemsdlt_captionposition">' +
                '<option value=""></option>' +
                '<option value="top">{{get_string "top" "editor"}}</option>' +
                '<option value="bottom">{{get_string "bottom" "editor"}}</option>' +
            '</select>' +
            '<br/>' +
            '<label for="{{elementid}}_atto_tablemsdlt_headers" class="sameline">{{get_string "headers" component}}</label>' +
            '<select class="{{CSS.HEADERS}}" id="{{elementid}}_atto_tablemsdlt_headers">' +
            ...
            '<br/>' +
            '{{#if nonedit}}' +
                '<label for="{{elementid}}_atto_tablemsdlt_rows" class="sameline">{{get_string "numberofrows" component}}</label>' +
                '<input class="{{CSS.ROWS}}" type="number" value="3" ' +
                'id="{{elementid}}_atto_tablemsdlt_rows" size="8" min="1" max="50"/>' +
                '<br/>' +
                '<label for="{{elementid}}_atto_tablemsdlt_columns" ' +
                'class="sameline">{{get_string "numberofcolumns" component}}</label>' +
                '<input class="{{CSS.COLUMNS}}" type="number" value="3" id="{{elementid}}_atto_tablemsdlt_columns"' +
                'size="8" min="1" max="20"/>' +
                '<br/>' +
            '{{/if}}' +
            '{{#if allowStyling}}' +
                ...
                '{{#if allowBorders}}' +
                    '<label for="{{elementid}}_atto_tablemsdlt_borders" class="sameline">{{get_string "borders" component}}</label>' +
                    '<select name="borders" class="{{CSS.BORDERS}}" id="{{elementid}}_atto_tablemsdlt_borders">' +
                    ...
                    '</select>' +
                    '<br>' +
                    '<label for="{{elementid}}_atto_tablemsdlt_borderstyle" class="sameline">' +
                    '{{get_string "borderstyles" component}}</label>' +
                    '<select name="borderstyles" class="{{CSS.BORDERSTYLE}}" id="{{elementid}}_atto_tablemsdlt_borderstyle">' +
                        '{{#each borderStyles}}' +
                            '<option value="' + '{{this}}' + '">' + '{{get_string this ../component}}' + '</option>' +
                        '{{/each}}' +
                    '</select>' +
                    '<br>' +
                    '<label for="{{elementid}}_atto_tablemsdlt_bordersize" class="sameline">' +
                    '{{get_string "bordersize" component}}</label>' +
                    '<input name="bordersize" id="{{elementid}}_atto_tablemsdlt_bordersize" class="{{CSS.BORDERSIZE}}"' +
                    'type="number" value="1" size="8" min="1" max="50"/>' +
                    '<label style="display: inline-block;">{{CSS.BORDERSIZEUNIT}}</label>' +
                    '<br>' +
                    '<label for="{{elementid}}_atto_tablemsdlt_bordercolour" class="sameline">' +
                    '{{get_string "bordercolour" component}}</label>' +
                    '<div id="{{elementid}}_atto_tablemsdlt_bordercolour"' +
                    'class="{{CSS.BORDERCOLOUR}} {{CSS.AVAILABLECOLORS}}" size="1">' +
                        '<label class="hideborder" for="{{../elementid}}_atto_tablemsdlt_bordercolour_-1"' +
                        'style="background-color:transparent;color:transparent">' +

                            '<input id="{{../elementid}}_atto_tablemsdlt_bordercolour_-1"' +
                        ...
                        '{{#each availableColours}}' +
                            '<label for="{{../elementid}}_atto_tablemsdlt_bordercolour_{{@index}}"' +
                            'style="background-color:{{this}};color:{{this}}">' +

                                '<input id="{{../elementid}}_atto_tablemsdlt_bordercolour_{{@index}}"' +
                ...
                '{{#if allowBackgroundColour}}' +
                    '<label for="{{elementid}}_atto_tablemsdlt_backgroundcolour" class="sameline">' +
                    '{{get_string "backgroundcolour" component}}</label>' +
                    '<div id="{{elementid}}_atto_tablemsdlt_backgroundcolour"' +
                    'class="{{CSS.BACKGROUNDCOLOUR}} {{CSS.AVAILABLECOLORS}}" size="1">' +
                        '<label class="hideborder" for="{{../elementid}}_atto_tablemsdlt_backgroundcolour_-1"' +
                        'style="background-color:transparent;color:transparent">' +

                            '<input id="{{../elementid}}_atto_tablemsdlt_backgroundcolour_-1"' +
                        ...
                        '{{#each availableColours}}' +
                            '<label for="{{../elementid}}_atto_tablemsdlt_backgroundcolour_{{@index}}"' +
                            'style="background-color:{{this}};color:{{this}}">'+

                                '<input id="{{../elementid}}_atto_tablemsdlt_backgroundcolour_{{@index}}"' +
                ...
                '{{/if}}' +
                '{{#if allowWidth}}' +
                    '<label for="{{elementid}}_atto_tablemsdlt_width" class="sameline">' +
                    '{{get_string "width" component}}</label>' +
                    '<input name="width" id="{{elementid}}_atto_tablemsdlt_width" class="{{CSS.WIDTH}}" size="8" ' +
...
Y.namespace('M.atto_tablemsdlt').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
...
//                    cell.setAttribute('scope', 'col');
    ...
    _setTable: function(e) {
        ...
        var nl = "\n";
        var tableId = Y.guid();
        tablehtml = '<br/>' + nl + '<table class="table table-bordered" id="' + tableId + '">' + nl;
